...
class SportList extends StatefulWidget {
  ...
  SportList({this.newsdata, this.newsdataimage});
  @override
...
class _SportListState extends State<SportList> {
  ...
  @override
  void initState() {
    crudObj.getSportData().then((results) {
      setState(() {
        newslist = results;
      });
    });
                      ...
                      Navigator.push(
                          ...
                          MaterialPageRoute(
                              builder: (context) => NewsPage(
                                    newstext: snapshot.data.documents[index]
                                        .data()['whole-text'],
                                    newsimage: snapshot.data.documents[index]
                                        .data()['image'],
                                  )));
                    },
                    child: Container(
                      ...
                      child: Container(
                        ...
                        child: Align(
                          ...
                          child: Padding(
                            ...
                            child: Text(
                              "${snapshot.data.documents[index].data()['whole-text']}",
